#!bin/bash
#Lrlrlr restraint.sh 051220 edited 230221 custom for ClusPro amended 090921 for cutoff 4A
...
cat *.txt | sed 's!/! !g'| sed 's!`! !g' > mainA #split everything into columns
...
#output files
tail -n +1  ResNumber_chainI ClusPro_chainI ResNumber_chainII ClusPro_chainII > residues4
