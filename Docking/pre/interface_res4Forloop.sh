#!bin/bash
#Lrlrlr restraint.sh 051220 edited 230221 edited 240321 custom forloop edited 090921 cutoff 4A.
...
do
	...
	tail -n +1  ResNumber_chainI ClusPro_chainI ResNumber_chainII ClusPro_chainII > $x.residues4
	rm temp* ClusPro* ResNum* main mainA
done
