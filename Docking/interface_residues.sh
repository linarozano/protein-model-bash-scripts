#!bin/bash
#Lrlrlr restraint.sh 051220 edited 230221 custom for ClusPro
...
cat *contacts*txt | sed 's!/! !g'| sed 's!`! !g' > main #print only 1st line
...
#output files
tail -n +1  ResNumber_chainI ClusPro_chainI ResNumber_chainII ClusPro_chainII > residues
